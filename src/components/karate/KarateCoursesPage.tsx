      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {courses.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-500 mt-2">Please check back later for upcoming courses.</p>
          </div>
        ) : (
                ...
                <div className="relative h-48 bg-gradient-to-br from-red-600 to-red-800">
                  ...
                  {course.beltLevelFrom && (
                    <div className="absolute top-4 left-4">
                      <span className={`px-3 py-1 rounded-full text-xs font-medium border ${BELT_COLORS[course.beltLevelFrom] || 'bg-gray-100'}`}>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="space-y-1">
                        ...
                        {course.schedules.length > 3 && (
                          <div className="text-xs text-gray-400">+{course.schedules.length - 3} more</div>
                        )}
                      </div>
                    </div>
                  )}
                    ...
                    <div className="mb-4">
                      <div className="flex flex-wrap gap-1">
                        {course.features.slice(0, 3).map((feature, idx) => (
                          <span key={idx} className="inline-flex items-center text-xs text-green-700 bg-green-50 px-2 py-0.5 rounded">
      ...
      <div className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900">Why Choose Our Karate Program?</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Learn from certified black belt instructors with years of teaching experience.</p>
            </div>
            <div className="text-center p-6">
              <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <UserGroupIcon className="h-8 w-8 text-red-600" />
              </div>
              <h3 className="text-lg font-semibold mb-2">All Ages Welcome</h3>
              <p className="text-gray-600">Programs designed for children, adults, and families to train together.</p>
            </div>
            <div className="text-center p-6">
              <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
