...
export default function CertificateActions({
  ...
  const verifyUrl =
    typeof window !== "undefined"
      ? `${window.location.origin}/${locale}/cert-verify?certId=${encodeURIComponent(certNumber)}`
      : "";
    ...
    <>
      <div className="flex items-center gap-2 flex-shrink-0">
        ...
        >
          ...
          <span className="hidden sm:inline">{t('certificates.actions.view')}</span>
        </button>
        ...
        <button
          ...
          title={t('certificates.actions.downloadTitle')}
        >
          {isRasterizing ? (
          ...
          <span className="hidden sm:inline">
            {isRasterizing ? t('certificates.actions.processing') : t('certificates.actions.download')}
          </span>
        </button>
        ...
        >
          ...
          <span className="hidden sm:inline">{t('certificates.actions.addToLinkedIn')}</span>
        </a>
      </div>
                ...
                >
                  <div className="flex flex-col items-center justify-center h-full gap-3 p-6 text-center">
                    ...
                    >
                      ...
                      {isRasterizing ? t('certificates.actions.processing') : t('certificates.actions.downloadInstead')}
                    </button>
                  </div>
                </object>
              ) : (
